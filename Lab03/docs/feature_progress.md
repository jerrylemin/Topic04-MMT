...
- Manual screenshot manifest/checker and DOCX generator implemented.
...
- Báo cáo DOCX được sinh từ source và evidence; các vị trí ảnh còn thiếu được liệt kê rõ.
