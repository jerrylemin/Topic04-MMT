...
- Complete: source/safety review and isolated Lab05 structure.
- Complete: vulnerable and secure login/search flows with fixed local scenarios.
- Complete: parameter binding, PBKDF2, safe errors, session rotation and headers.
...
- Complete: evidence-driven DOCX report.
